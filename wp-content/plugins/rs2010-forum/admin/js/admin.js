...
(function($) {
    $(document).ready(function() {
        ...
        $('#rs-options #settings-tabs li').click(function() {
            // Get slug.
            var tab = $(this).attr('data-slug');

            // Set slug.
            $('#rs-options input[name=selected_tab]').val(tab);

            // Change highlighted tab.
            $('#rs-options #settings-wrapper #settings-tabs li').removeClass('active-tab');
            $('#rs-options #settings-wrapper #settings-tabs li[data-slug='+tab+']').addClass('active-tab');

            // Hide all tabs.
            $('#rs-options #settings-wrapper .tab').css('display', 'none');

            // Show selected tab.
            $('#rs-options #settings-wrapper #tab-'+tab).css('display', 'block');
        });
        ...
        $('select[name="theme"]').change(function() {
            if ($('select[name="theme"]').val() === 'default') {
                $('#rs-options .custom-color-selector').show();
            } else {
                $('#rs-options .custom-color-selector').hide();
            }
        });
        ...
        $('.show_hide_initiator').change(function() {
            ...
            if (this.checked) {
                $('#rs-options .'+hideClass).show();
            } else {
                $('#rs-options .'+hideClass).hide();
            }
        });
