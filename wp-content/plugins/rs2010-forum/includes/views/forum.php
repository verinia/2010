...
if ($counter_total > 0) {
    echo '<div class="brown-box-area"><div class="title-element" id="title-element-forum-'.$this->current_forum.'">';
        echo __('Topics', 'rs2010-forum');
...
//    echo '<div class="title-element" id="title-element-forum-'.$this->current_forum.'"></div>';
    ...
    echo '<div class="content-container" id="content-container-forum-'.$this->current_forum.'">';
        $this->render_notice(__('There are no topics yet!', 'rs2010-forum'));
    echo '</div>';
}
