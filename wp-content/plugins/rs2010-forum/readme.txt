=== Rs2010 Forum ===
Contributors: Rs2010, qualmy91
Donate link: https://www.rs2010.de/donate/
Tags: forum, forums, discussion, multisite, community, bulletin, board, rs2010, support
...
Rs2010 Forum is the best forum-plugin for WordPress! It comes with dozens of features in a beautiful design and stays simple and fast.

== Description ==
Rs2010 Forum is the perfect WordPress plugin if you want to extend your website with a lightweight and feature-rich discussion board. It is easy to set up, super fast and perfectly integrated into WordPress.

= Support, Demo & Documentation =
* [Support & Demo](https://www.rs2010.de/support/)
* [Documentation](https://www.rs2010.de/docs/)
...
[https://gist.github.com/Rs2010/6d4b88b1f5013efb910d9fcd01284698](https://gist.github.com/Rs2010/6d4b88b1f5013efb910d9fcd01284698).
= I want help to translate Rs2010 Forum =
You can help to translate Rs2010 Forum on this site:
[https://translate.wordpress.org/projects/wp-plugins/rs2010-forum](https://translate.wordpress.org/projects/wp-plugins/rs2010-forum).
...
You can add own themes for your forum in the `/wp-content/themes-rs2010forum` directory (for example: `/wp-content/themes-rs2010forum/my-theme`). All themes in the `/wp-content/themes-rs2010forum` can be activated in the forum options. Each theme must have the following files: `style.css`, `widgets.css` and `editor.css`.
= Which hooks and filters are available? =
You can find a list of available hooks and filters on this site:
[https://www.rs2010.de/support/?view=thread&id=407](https://www.rs2010.de/support/?view=thread&id=407).
...
== Changelog ==
= 1.15.9 =
* Added: rs2010forum_filter_show_header filter
* Added: rs2010forum_filter_upload_folder filter
...
= 1.15.8 =
* Added: rs2010forum_filter_meta_post_type filter
...
* Added: rs2010forum_signature filter
* Added: rs2010forum_filter_header_menu filter
...
* Added: rs2010forum_title_separator filter
* Added: rs2010forum_filter_profile_header_image filter
...
* Changed: rs2010forum_widget_recent_posts_custom_content is now a filter
* Changed: rs2010forum_widget_recent_topics_custom_content is now a filter
...
* Added: rs2010forum_profile_row action
* Added: rs2010forum_after_add_reaction action
* Added: rs2010forum_after_remove_reaction action
* Added: rs2010forum_after_update_reaction action
...
* Added: rs2010forum_enqueue_css_js action
...
* Added: rs2010forum_reactions filter
* Added: rs2010forum_execution_check action
...
* Added: rs2010forum_seo_trailing_slash filter
...
* Added: rs2010forum_after_topic_approve hook
...
* Added: rs2010forum_widget_excerpt_length filter
...
* Fixed: Display issues in the administration-area of Rs2010 Forum when notices of WordPress or other plugins are shown
...
* Added: rs2010forum_content_top hook
* Added: rs2010forum_content_header hook
* Added: rs2010forum_after_category hook
* Added: rs2010forum_after_forum hook
* Added: rs2010forum_after_topic hook
* Added: rs2010forum_after_post hook
* Added: rs2010forum_content_bottom hook
* Added: rs2010forum_add_admin_submenu_page hook
* Fixed: Rare javascript-errors with some themes
* Removed: rs2010forum_after_first_post hook
* Minor design changes
...
* Added: rs2010forum_user_replacements filter
...
* Added: rs2010forum_prepare hook
* Added: rs2010forum_usergroup_{ID}_add_user hooks
* Added: rs2010forum_usergroup_{ID}_remove_user hooks
* Added: rs2010forum_breadcrumbs_{current_view} hooks
...
* Added: rs2010forum_wp_head hook
* Added: rs2010forum_bottom_navigation hook
* Added: rs2010forum_filter_editor_buttons filter
...
= 1.9.5 =
* Added: rs2010forum_custom_profile_menu hook
...
* Added: rs2010forum_widget_recent_posts_custom_content hook
* Added: rs2010forum_widget_recent_topics_custom_content hook
= 1.9.0 =
...
* Removed: rs2010forum_filter_subscribers_query_new_post filter
* Removed: rs2010forum_filter_subscribers_query_new_topic filter
* Changed: Minor design changes
* Changed: Mobile theme improvements
...
* Added: rs2010forum_filter_notify_mentioned_user_message filter
...
* Added: rs2010forum_prepare_{current_view} hooks
* Added: rs2010forum_filter_get_sticky_topics_order filter
...
* Added: rs2010forum_filter_widget_avatar_size filter
* Fixed: Parse error when using some older versions of PHP
* Fixed: Wrong stylings when using custom colors
* Fixed: Display issues on mobile devices
...
= 1.6.7 =
* Added: Members list
* Added: rs2010forum_filter_members_link filter
* Added: rs2010forum_filter_automatic_topic_title filter
* Added: rs2010forum_filter_automatic_topic_content filter
...
* Changed: Minor design changes
* Changed: Renamed rs2010forum_after_add_thread_submit hook into rs2010forum_after_add_topic_submit
* Performance improvements and code optimizations
= 1.6.3 =
...
* Added: rs2010forum_filter_forum_menu filter
* Added: rs2010forum_filter_topic_menu filter
* Added: rs2010forum_filter_post_menu filter
* Changed: Minor design changes
* Performance improvements and code optimizations
...
* Added: rs2010forum_custom_header_menu hook
...
* Added: rs2010forum_filter_avatar_size filter
...
* Added: rs2010forum_after_first_post hook
* Added: rs2010forum_custom_forum_column hook
* Added: rs2010forum_custom_topic_column hook
...
* Added: rs2010forum_before_delete_post hook
* Added: rs2010forum_before_delete_topic hook
* Added: rs2010forum_after_delete_post hook
* Added: rs2010forum_after_delete_topic hook
* Fixed: Huge performance drops when the forum has a lot of posts/topics
...
* Added: rs2010forum_filter_widget_title_length filter
...
* Changed: Minor design changes
* Removed: rs2010forum_action_add_category_form_fields hook
* Removed: rs2010forum_action_edit_category_form_fields hook
* Removed: rs2010forum_action_save_category_form_fields hook
* Removed: rs2010forum_filter_manage_columns filter
* Removed: rs2010forum_filter_manage_custom_columns filter
= 1.4.1 =
...
* Added: rs2010forum_statistics_custom_element hook
* Added: rs2010forum_statistics_custom_content_bottom hook
* Fixed: Display issues with some themes
* Changed: Minor design changes
= 1.3.1 =
...
* Added: rs2010forum_filter_error_message_require_login filter
...
* Added: rs2010forum_{current_view}_custom_content_top hooks
* Added: rs2010forum_{current_view}_custom_content_bottom hooks
* Added: rs2010forum_filter_subscribers_query_new_topic filter
* Added: rs2010forum_filter_subscribers_query_new_post filter
* Added: rs2010forum_subscriber_mails_new_topic filter
* Added: rs2010forum_subscriber_mails_new_post filter
* Changed: Minor design changes
* Performance improvements and code optimizations
...
* Added: rs2010forum_filter_subject_before_insert filter
* Added: rs2010forum_filter_content_before_insert filter
* Changed: Read/Unread icons are now better recognizable
* Changed: Renamed rs2010forum_filter_notify_administrator_message filter into rs2010forum_filter_notify_global_topic_subscribers_message
* Performance improvements and code optimizations
= 1.2.3 =
...
* Changed: Added amount of posts to the rs2010forum_after_post_author hook
= 1.2.2 =
...
* Added: rs2010forum_filter_login_message filter
* Performance improvements and code optimizations
= 1.2.1 =
...
* Added: rs2010forum_editor_custom_content_bottom hook
* Added: rs2010forum_filter_insert_custom_validation filter
* Performance improvements and code optimizations
= 1.1.6 =
...
* Added: rs2010forum_filter_notify_administrator_message filter
* Added: rs2010forum_filter_notify_topic_subscribers_message filter
* Changed: Revised editor
* Changed: Improved error handling
* Changed: Post number is linking to the post now instead of the date
* Changed: Added post ID to rs2010forum_after_post_message hook
* Changed: Renamed rs2010forum_after_thread_submit hook into rs2010forum_after_add_thread_submit
* Changed: Renamed rs2010forum_after_post_submit hook into rs2010forum_after_add_post_submit
* Changed: Renamed rs2010forum_after_edit_submit hook into rs2010forum_after_edit_post_submit
...
* Added: rs2010forum_after_post_message hook
* Added: rs2010forum_filter_get_posts filter
* Added: rs2010forum_filter_get_posts_order filter
* Performance improvements and code optimizations
= 1.1.4 =
...
* Fixed: Display issues with some themes
* Added: rs2010forum_filter_post_username filter
...
* Added: rs2010forum_after_thread_submit hook
* Added: rs2010forum_after_post_submit hook
* Added: rs2010forum_after_edit_submit hook
* Changed: Minor design changes
...
* Added: Filter rs2010forum_filter_editor_settings
* Changed: Improved compatibility with some third-party plugins
* Performance improvements and code optimizations
= 1.0.8 =
...
* Added: Filter rs2010forum_filter_get_threads
* Added: Filter rs2010forum_filter_get_threads_order
...
* Added: Filter hook rs2010forum_filter_post_content
...
* Changed: Added author_id to rs2010forum_after_post_author action hook
* Performance improvements and code optimizations
= 1.0.5 =
* Added: Option to easily change the forum color
* Added: Option to limit access to logged in users
* Added: Action hook rs2010forum_after_post_author
...
* Changed: Minor design changes
* Changed: Translation slug from rs2010forum to rs2010-forum
